...
import com.example.datn.models.attendance.AttendanceX
import com.example.datn.util.Util

class AttendanceForManageAdapter : ListAdapter<AttendanceX, AttendanceForManageAdapter.AttendanceViewHolder>(AttendanceDiffCallback()) {
    ...
    class AttendanceDiffCallback : DiffUtil.ItemCallback<AttendanceX>() {
        override fun areItemsTheSame(oldItem: AttendanceX, newItem: AttendanceX): Boolean {
            // So sánh ID hoặc time+date unique
            return oldItem._id == newItem._id
        }

        override fun areContentsTheSame(oldItem: AttendanceX, newItem: AttendanceX): Boolean {
